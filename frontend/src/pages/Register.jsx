    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-gray-600 mt-2 dark:text-gray-400">Join the gaming community!</p>
        </div>

        {/* Register Form */}
        <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6 dark:bg-dark-800 dark:border-dark-700">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 md:mb-6 dark:text-white">Create Account</h2>
          ...
          <div className="flex items-center gap-3 my-4">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400">or register with email</span>
            <div className="flex-1 h-px bg-gray-200 dark:bg-dark-600" />
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-start">
              <input
                ...
                className="w-4 h-4 mt-0.5 rounded border-dark-600 bg-dark-700 text-cyan-500 focus:ring-cyan-500"
              />
          ...
          <div className="relative my-4 md:my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500 dark:bg-dark-800 dark:text-gray-400">Already have an account?</span>
            </div>
          </div>
